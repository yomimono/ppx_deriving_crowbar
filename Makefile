...
parsetree:
	ocamlfind ocamlopt -ppx '`ocamlfind query ppx_import`/ppx_import' -ppx '`ocamlfind query ppx_deriving`/ppx_deriving _build/src/ppx_deriving_crowbar.cma' -ppx '`ocamlfind query ppx_deriving`/ppx_deriving `ocamlfind query ppx_deriving`/ppx_deriving_eq.cma' -package crowbar -package ppx_deriving.runtime -package compiler-libs -package ocaml-migrate-parsetree -package ppx_deriving.std -linkall -linkpkg test/asttypes.ml test/parsetree.ml -o test/$@
